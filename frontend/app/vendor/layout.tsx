...
export default function VendorLayout({
  ...
  const toggleSidebar = () => {
    ...
    localStorage.setItem('vendor-sidebar-collapsed', String(newState));
  };
          ...
          {!isCollapsed && (
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                ...
                <h2 className="font-bold text-lg truncate">Vendor Panel</h2>
              </div>
              <p className="text-sm text-muted-foreground truncate">
                {user?.vendorBusinessName || user?.name || 'Vendor'}
              </p>
            </div>
          )}
          {isCollapsed && (
